...
export default class PageLayoutExplorer extends LightningElement {
    ...
    async handleDownloadAll() {
        ...
        try {
            this.setLoading(true);
            const allLayouts = await getAllLayoutsWithFields({ objectName: this.selectedObject });
            ...
            downloadElement.download = `${this.selectedObject}_AllLayouts_${this.getTimestamp()}.csv`;
